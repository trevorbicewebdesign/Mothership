...
namespace Mothership\Component\Mothership\Administrator\Service;
...
class EmailService
{
    ...
    {
        $layout = new FileLayout($layoutName, JPATH_COMPONENT_ADMINISTRATOR . '/layouts');
    ...
    {
        $file = JPATH_COMPONENT_ADMINISTRATOR . '/layouts/' . str_replace('.', '/', $layoutName) . '.php';
