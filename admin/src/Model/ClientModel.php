...
namespace Joomla\Component\Mothership\Administrator\Model;
...
class ClientModel extends AdminModel
{
    ...
    protected function canEditState($record)
    {
        ...
        if (!empty($record->catid)) {
            return $user->authorise('core.edit.state', 'com_mothership.category.' . (int) $record->catid);
        }

        return $user->authorise('core.edit.state', 'com_mothership');
    }
