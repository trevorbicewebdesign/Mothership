...
class AccountCenterPaymentsCest
{
    private $clientData;
    private $userData;
    private $accountData;
     ...
     * @group payment
     */
    public function accountCenterViewAllPaymentsPage(AcceptanceTester $I)
    {
     ...
     * @group payment
     */
    public function accountCenterViewPaymentPage(AcceptanceTester $I)
    {
